...
Install a Few Additional Packages There are a few additional packages we'll be using during the course of this project that are not included when you download Anaconda - wordcloud, textblob and gensim.
